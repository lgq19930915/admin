  ...
  <div>
    <el-dialog :title="s.title" :visible.sync="s.showDialog">
      <el-row>
        ...
        <el-col :span="20">
          <el-input v-model="user.name" :disabled="!s.isAdd"></el-input>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="4" class="lable">密码：</el-col>
        <el-col :span="20">
          <el-input v-model="user.pass" show-password :disabled="!s.isAdd"></el-input>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        <el-col :span="4" class="lable">属性：</el-col>
        <el-col :span="20">
...
export default {
  ...
  methods: {
    ...
    confirm() {
      ...
      //   发请求
      requestAddManage(data).then(res => {
        //   添加成功，1弹内容
        if (res.data.isok) {
          this.$message({
